...
const main = {
  ...
  createMarket: {
    ...
    overviewDes: name('500 characters to help new members get to know your market. Overview cannot be changed.', '簡單介紹你的項目，限500個字元，巿場概要在創建巿場後無法更改。', '简单介绍你的项目，限500个字元，巿场概要在创建巿场后无法更改。'),
