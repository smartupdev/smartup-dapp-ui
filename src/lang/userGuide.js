...
export default {
  ...
  faqGeneral: name(
    ...
    **Who can use SmartUp platform?**
    ...
    Investors who looking for potential investment opportunities!
    ...
    **How can I start with SmartUp?**
    ...
    1. Click on the second icon ‘Create Market’ of the navigation bar at your left-hand side. Or, you can click on here to create your market.
    2. Input market name and overview, upload the market icon and photo
    3. Click “Next”
    4. Review the price curve of market token
    5. Click “Next”
    6. Confirm the market creation deposit – 2500 SmartUp token
    7. Click “Create” and wait for few minutes
    8. You can preview your market page at this moment; however functions will be all disabled until the market is successfully created
    _To invest_
    ...
    1. Go to targeted market
    2. Click “Trading” tab
    3. Input the amount of market tokens you want to buy
    4. Click on the Terms of Service
    5. Click “Trade”
    6. Wait for the confirmation in the Notification in the dashboard at right-hand side
    7. You will become a market follower after you have successfully bought market tokens. Buy low and sell high to make profits
    ...
    **What should I prepare before using SmartUp Incubator Platform?**
    ...
    4. Lastly, you go clicking ‘Create Market’ in the navigation bar at your left-hand side!    
    **What is Metamask?**
    MetaMask is a 3rd party bridge that allows you to visit the distributed web and dapp like SmartUp Incubator Platform in Google Chrome Browser. It allows you to run Ethereum dApps right in your browser without running a full Ethereum node.
    You may see it as an ETH wallet where ETH and SmartUp Token are stored. Simply install the MetaMask extension, click on connecting with SmartUp Incubator Platform, then you can start make good use of the SmartUp Incubator Platform.
    ...
    **How do I top up my Metamask wallet?**
    ...
    1. Copy the Metamask wallet address by clicking the account name in Metamask
    2. Click “Send” in your old wallet
    3. Input the amount
    4. Paste the Metamask wallet address in recipient’s address
    5. Click “Confirm”
    6. Transaction will be completed within few minutes
    *Procedure may vary between different wallet
    Import old wallet with its private key
    1. Copy the private key of your old wallet
    2. Click the flavicon at the top right corner of your MetaMask pop-up
    3. Select “Import Account”
    4. You will be directed to the New Account page. Paste your private key and click “Import”
    5. Click on the flavicon to check new imported account
    ...
    **我如何開始使用SmartUp？**
    ...
    1.點擊左側導航欄的第二個圖標“創建市場”，或點擊此處創建巿場。
    2.輸入市場名稱和概要，上傳市場圖片和封面圖片
    3. 點擊“下一步”
    4.查看市場代幣的價格方程及曲線
    5. 點擊“下一步”
    6.確認市場創建存款 -2500 SmartUp
    7. 點擊“創建”並等待幾分鐘
    8.此時您可以預覽您的市場頁面；但在成功創建市場之前，所有功能都將被禁用
    _投資_
    ...
    5.點擊“交易”
    6.等待右側通知欄中的確認訊息
    7.成功購買市場代幣後，你便成為了市場關注者，然後透過低買高賣獲利
    **我身處的地方可以使用SmartUp嗎？**
    ...
    **在使用SmartUp孵化器平台之前，我應該準備什麼？**
    ...
    3.確保MetaMask錢包中有足夠的ETH和SmartUp
    4.最後，您點擊左側導航欄中的“創建市場”！
    **什麼是Metamask？**
    ...
    **如何充值Metamask錢包？**
    _從另一個錢包匯入款項：_
    1.通過點擊Metamask中的帳戶名稱，複製Metamask錢包地址
    2. 點擊舊有錢包中的“發送”
    3. 輸入金額
    4. 將Metamask錢包地址粘貼到收件人的地址上
    5.  點擊“確認”
    6. 交易將在幾分鐘內完成
    *以上程序可能因錢包而異
    _使用私鑰導入舊錢包：_
    1. 複製舊錢包的私鑰
    2. 點擊瀏覽器右上角的MetaMask的圖示，點擊MetaMask彈出窗口中右上圓形圖示
    3. 選擇“導入帳戶”
    4.您將導向到導入新帳戶頁面。貼上你的私鑰，然後點擊“導入”
    5.點擊右上角圓形圖示檢查新導入的帳戶
    *在此連結查看詳細程序：https://metamask.zendesk.com/hc/en-us/articles/360015489331-Importing-an-Account
    **我可以使用自己的加密貨幣錢包嗎？**
    可以的，你可以按照以下步驟操作：
    1. 複製舊錢包的私鑰
    2. 點擊MetaMask彈出窗口右上角的圖示
    3. 選擇“導入帳戶”
    4. 您將導向到導入新帳戶頁面。貼上你的私鑰，然後點擊“導入”
    5.點擊右上角圓形圖示檢查新導入的帳戶
    *在此連結查看詳細程序：https://metamask.zendesk.com/hc/en-us/articles/360015489331-Importing-an-Account
    ...
    **我如何开始使用SmartUp？**
    ...
    1.点击左侧导航栏的第二个图标“创建市场”，或点击此处创建巿场。 
    2.输入市场名称和概要，上传市场图片和封面图片
    3.点击“下一步”
    4.查看市场代币的价格方程及曲线
    5.点击“下一步”
    6.确认市场创建存款 -2500 SmartUp
    7.点击“创建”并等待几分钟
    8.此时您可以预览您的市场页面；但在成功创建市场之前，所有功能都将被禁用
    _投资_
    ...
    5.点击“交易”
    6.等待右侧通知栏中的确认讯息
    7.成功购买市场代币后，你便成为了市场关注者，然后透过低买高卖获利
    **我身处的地方可以使用SmartUp吗？**
    世界各地的人都可以使用SmartUp孵化器平台。 
    **在使用SmartUp孵化器平台之前，我应该准备什么？**
    ...
    3.确保MetaMask钱包中有足够的ETH和SmartUp
    4.最后，您点击左侧导航栏中的“创建市场”！ 
    **什么是Metamask？**
    ...
    **如何充值Metamask钱包？**
    从另一个钱包汇入款项：
    1.通过点击Metamask中的帐户名称，复制Metamask 钱包地址
    2.点击旧有钱包中的“发送”
    3.输入金额
    4.将Metamask钱包地址粘贴到收件人的地址上
    5.点击“确认”
    6.交易将在几分钟内完成
    *以上程序可能因钱包而异
    使用私钥导入旧钱包：
    1.复制旧钱包的私钥
    2.点击浏览器右上角的MetaMask的图标，点击 MetaMask弹出窗口中右上饼图示
    3.选择“导入账户”
    4.您将导向到导入新帐户页面。 贴上你的私钥，然后点击“导入”
    5.点击右上角饼图示检查新导入的帐户
    *在此链接查看详细程序：https://metamask.zendesk.com/hc/en-us/articles/360015489331-Importing-an-Account
    **我可以使用自己的加密货币钱包吗？**
    可以的，你可以按照以下步骤操作：
    1.复制旧钱包的私钥
    2.点击MetaMask弹出窗口右上角的图示
    3.选择“导入账户”
    4.您将导向到导入新帐户页面。 贴上你的私钥，然后点击“导入”
    5.点击右上角饼图示检查新导入的帐户
    *在此链接查看详细程序：https://metamask.zendesk.com/hc/en-us/articles/360015489331-Importing-an-Account 
  ...
  faqCreator: name(
    ...
    **What should I prepare for creating a market?**
    1. Install softwares you need:
    • Open Google Chrome Browser
    Download the Chrome at this link: https://www.google.com/chrome/
    • Metamask
    Install Metamask Chrome extension at this link: https://metamask.io/
    • Ensure there is enough ETH & SmartUp Tokens in MetaMask Wallet
    2. Prepare your idea details including:
    ...
    3. Lastly, click on the second icon ‘Create Market’ of the navigation bar at your left-hand side Or, you can click on here to create your market.
    4. Input market name and overview, upload the market icon and photo
    5. Click “Next”
    6. Review the price curve of market token
    7. Click “Next”
    8. Confirm the market creation deposit – 2500 SmartUp token
    9. Click “Create” and wait for few minutes
    10. You can preview your market page at this moment; however, functions will be all disabled until the market is successfully created
    ...
    **我應該為創建市場做些什麼準備？**
    ...
    3. 最後，點擊左側導航欄的第二個圖標“創建市場”
    4. 輸入市場名稱和概述，上傳市場圖示和封面照片
    5. 點擊“下一步”
    6. 查看市場代幣的價格曲線
    7. 點擊“下一步”
    8. 確認市場創建存款 -  2500 SmartUp
    9. 點擊“創建”並等待幾分鐘
    10. 此時您可以預覽您的市場頁面；但是在成功創建市場之前，巿場內的功能將全部禁用
    **如何創建項目？**
    1. 點擊左側導航欄的第二個圖標“創建市場”
    2. 輸入市場名稱和概述，上傳市場圖示和封面照片
    3. 點擊“下一步”
    4. 查看市場代幣的價格曲線
    5. 點擊“下一步”
    6. 確認市場創建存款 -  2500 SmartUp
    7. 點擊“創建”並等待幾分鐘
    8. 此時您可以預覽您的市場頁面；但是在成功創建市場之前，巿場內的功能將全部禁用
    **創造市場需要多少SUT？**
    ...
    **我可以編輯市場的信息嗎？**
    ...
    •Metamask
    在链接安装Metamask Chrome扩展程序：https： //metamask.io/
    ...
    让大家轻易区分出你的市场！ 
    市场封面照片
    展示产品或概念的形象，可以与项目的背景、目标和时间表有关， 这些都是你的投资者和市场关注者需要了解的数据！ 
    3.最后，点击左侧导航栏的第二个图标“创建市场”
    4.输入市场名称和概述，上传市场图示和封面照片
    5.点击“下一步”
    6.查看市场代币的价格曲线
    7.点击“下一步”
    8.确认市场创建存款 - 2500 SmartUp
    9.点击“创建”并等待几分钟
    10.此时您可以预览您的市场页面；但是在成功创建市场之前，巿场内的功能将全部禁用
    如何创建项目？
    1.点击左侧导航栏的第二个图标“创建市场”
    2.输入市场名称和概述，上传市场图标和封面照片
    3.点击“下一步”
    4.查看市场代币的价格曲线
    5.点击“下一步”
    6.确认市场创建存款 - 2500 SmartUp
    7.点击“创建”并等待几分钟
    8.此时您可以预览您的市场页面；但是在成功创建市场之前，巿场内的功能将全部禁用
    **创造市场需要多少SUT？**
  ...
  faqInvestor: name(
    ...
    **Can I withdraw my investment, and how?**
    ...
    1. Go to targeted market
    2. Click “Trading” tab
    3. Input the amount of market tokens you want to sell
    4. Click on the Terms of Service
    5. Click “Trade”
    6. Wait for the confirmation in the Notification in the dashboard at right-hand side
    7. You will quit the market after you have successfully sold out all market tokens.
