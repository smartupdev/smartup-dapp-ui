...
const faqs = [
  ...
  },
  {
    ...
    body: (
      <Col>
        ...
        <Text TopXS lineHeight S>1.	Click on the second icon ‘Create Market’ of the navigation bar at your left-hand side. Or, you can click on <A S onClick={() => goto.createMarket()}>here</A> to create your market.</Text>
  ...
  },
  {
    ...
    body: (
      <Col>
        ...
        <Text lineHeight S>Download the Chrome at this link: <A href='https://www.google.com/chrome/'>https://www.google.com/chrome/ </A></Text>
        <Text TopXS lineHeight S>2.	Metamask</Text>
        <Text lineHeight S>Install Metamask Chrome extension at this link: <A href='https://metamask.io/'>https://metamask.io/ </A></Text>
  ...
  },
  {
    ...
    body: (
      <Col>
        ...
        <Text TopXS lineHeight S>Download MetaMask extension here: <A href='https://metamask.io'>https://metamask.io</A></Text>
      </Col>
    )
  },
  {
    ...
    body: (
      <Col>
        ...
        <Text lineHeight S><A href='https://www.coinbene.com/exchange.html#/exchange?pairId=SMARTUPETH'>https://www.coinbene.com/exchange.html#/exchange?pairId=SMARTUPETH </A></Text>
      </Col>
    )
  },
  {
  ...
  },
  {
    ...
    body: (
      <Col>
        ...
        <Text TopXS lineHeight S>** Detailed procedure in this link:<A href=' https://metamask.zendesk.com/hc/en-us/articles/360015489331-Importing-an-Account '> https://metamask.zendesk.com/hc/en-us/articles/360015489331-Importing-an-Account </A></Text>
      </Col>
    )
  },
  {
  ...
  },
  {
    ...
    body: (
      <Col>
        ...
        <Text TopXS lineHeight S>3.	Lastly, click on the second icon ‘Create Market’ of the navigation bar at your left-hand side Or, you can click on <A S onClick={() => goto.createMarket()} >here</A> to create your market.</Text>
  ...
  },
  {
    ...
    body: (
      <Col>
        <Text lineHeight S>1.	Click on the second icon ‘Create Market’ of the navigation bar at your left-hand side (Or, you can click on <A S onClick={() => goto.createMarket()}>here</A> to create your market.)</Text>
        <Text TopXS lineHeight S>2.	Input market name and overview, upload the market icon and photo</Text>
        <Text TopXS lineHeight S>3.	Click “Next”</Text>
        <Text TopXS lineHeight S>4.	Review the price curve of market token</Text>
        <Text TopXS lineHeight S>5.	Click “Next”</Text>
  ...
  },
  {
    ...
    body: (
      <Col>
        ...
        <Text lineHeight S>Personal Center: <A S onClick={() => goto.accountTransaction()}>account/transaction</A></Text>
      </Col>
    )
  },
  {
